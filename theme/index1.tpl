                ...
                <div class="panel panel-info">
                  ...
                  <div class="panel-body ">
                    {if !empty($berita[0]->images)}
                      <img  width="200" class="img-rounded" src="{$berita[0]->images}" alt="{$berita[0]->images}">
                    {/if}
                      {foreach from=$listimage item=images}
                        {if $berita[0]->token == $images->token}
                        <a href="{$images->linkphoto}" >
                          <img  class="img-thumbnail" src="{$images->thumbnail}" alt="{$images->namaphoto}">
                        </a>
                        {/if}
                      {/foreach} 
                      <div class="full-left">
                      ...
                      {foreach from=$listkomentar item=komentar}
                        {if $berita[0]->id == $komentar->idberita}
                          <div class="media bg-warning" id="{$komentar->id}">
                            <div class="media-left">
                ...
                <div class="panel panel-info">
                  ...
                  <div class="panel-body ">
                    {if !empty($beritas->images)}
                      <img  width="200" class="img-rounded" src="{$beritas->images}" alt="{$beritas->images}">
                    {/if}
                      {foreach from=$listimage item=images}
